...
if (isset($_POST['submitted'])) 
{
    ...
    if (empty($errors)) 
    {
        $ARTISTQUERY = "INSERT INTO artist (artistID,fname, lname, dob, nationality, contactinfo, biography, personallinks, staffID) VALUE ('$artistid', '$fname', '$lname', '$dob', '$nationality', '$contactinfo', '$biography', '$personallinks', '$staffid')";
        $ARTISTRESULT = mysqli_query($DBCONN, $ARTISTQUERY);

        if ($ARTISTRESULT) {
             echo "<h1>Artist successfully added</h1>";
        } else {
             echo "Error adding artist: " . mysqli_error($DBCONN);
        }
    } 
    else 
    {
...
<h3 align="center">Add New Artists</h3>
<div class="formtable">
    <form action="new_artist.php" method="POST">
        <table class="formtable">
             <tr>
                <td>ArtistID:</td>
                <td>
                    <input type="text" id="artistID" name="artistID" size="8" maxlength="8" placeholder="Numbers only">
                </td>
            </tr>
             <tr>
                <td>First Name:</td>
            ...
            <tr>
             ...
             <tr>
                <td>Nationality:</td>
                <td>
                    <input type="text" id="nationality" name="nationality" size="20" maxlength="20">
                </td>
            </tr>
             <tr>
                <td>Contact Info:</td>
